...
class CollectionScreenTest {
  ...
  fun clearRepos(){
    runBlocking {
      LocalRepositories.clearUserAnimalsAndAnimals()
    }
  }
  ...
  fun testTagsAreCorrectlySetWhenNoAnimalAndCurrentUser() {
    ...
    composeTestRule
      .onNodeWithTag(CollectionScreenTestTags.PROFILE_BUTTON)
      .assertIsDisplayed()
    composeTestRule
      .onNodeWithTag(CollectionScreenTestTags.NOTIFICATION_BUTTON)
      .assertIsDisplayed()
    composeTestRule
      .onNodeWithTag(CollectionScreenTestTags.GO_BACK_BUTTON)
      .assertIsNotDisplayed()
    composeTestRule
      .onNodeWithTag(CollectionScreenTestTags.ANIMAL_LIST)
      .assertIsNotDisplayed()
    composeTestRule
  ...
  fun profilePictureClick_invokesCallback() {
    ...
    composeTestRule.setContent {
      CollectionScreen(collectionScreenVM, userUid = "currentUserId", onProfileClick = { profileClicked = true })
    }
  ...
  fun notificationClick_invokesCallback() {
    ...
    composeTestRule.setContent {
      CollectionScreen(collectionScreenVM, userUid = "currentUserId", onNotificationClick = { notificationClicked = true })
    }
  ...
  fun goBackClick_invokesCallback() {
    ...
    composeTestRule.setContent {
      CollectionScreen(collectionScreenVM, userUid = "otherUserId", onGoBack = { goBackClicked = true })
    }
