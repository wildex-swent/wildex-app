...
class EditProfileScreenTest {
    ...
    fun initialState_showsFields_andProfilePreview() {
        ...
        composeRule.onNodeWithTag(EditProfileScreenTestTags.INPUT_USERNAME).assertTextContains("jane_doe")
        composeRule.onNodeWithTag(EditProfileScreenTestTags.INPUT_DESCRIPTION).assertTextContains("Bio of Jane")
    ...
    fun countryDropdown_opens_and_selects_country() {
        ...
        composeRule.onNode(
            hasClickAction().and(
                hasAnyAncestor(hasTestTag(EditProfileScreenTestTags.DROPDOWN_COUNTRY))
            ),
        ...
        composeRule.onNodeWithTag(EditProfileScreenTestTags.DROPDOWN_COUNTRY)
            .assertIsDisplayed()
    }
