...
class ReportScreenTest {
    ...
    fun setup() = runBlocking {
        ...
        val report1 = Report(
            reportId = "reportId1",
            imageURL = "https://leesbird.com/wp-content/uploads/2012/01/ring-billed-gull-imm-injured-wing-1c.jpg",
        ...
        val simpleUser1 = SimpleUser(
            userId = "user1",
            username = "Bob1",
            profilePictureURL = "urlBob1")

        val simpleUser2 = SimpleUser(
            userId = "user2",
            username = "Alice2",
            profilePictureURL = "urlAlice2")

        val simpleUser3 = SimpleUser(
            userId = "user3",
            username = "Charlie3",
            profilePictureURL = "urlCharlie3")
    ...
    fun notificationBellClick_invokesCallback() {
        ...
        composeRule.setContent {
            ReportScreen(reportScreenViewModel = reportScreenViewModel, onNotificationClick = { notificationClicked = true })
        }
    ...
    fun testTagsAreCorrectlySetWhenReports() {
        ...
        composeRule.onNodeWithTag(ReportScreenTestTags.testTagForProfilePicture("user2"), useUnmergedTree = true).assertIsDisplayed()
        composeRule.onNodeWithTag(ReportScreenTestTags.testTagForProfilePicture("user3"), useUnmergedTree = true).assertIsDisplayed()
