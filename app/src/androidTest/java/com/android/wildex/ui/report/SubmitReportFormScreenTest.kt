...
class SubmitReportFormScreenTest {
    ...
    fun shows_camera_placeholder_when_no_image_selected() {
        ...
        composeTestRule.onNodeWithTag(SubmitReportFormScreenTestTags.CAMERA_ICON, useUnmergedTree = true).assertIsDisplayed()
    }
    ...
    fun shows_selected_image_when_uri_is_provided() {
        ...
        composeTestRule.onNodeWithTag(SubmitReportFormScreenTestTags.SELECTED_IMAGE, useUnmergedTree = true).assertIsDisplayed()
    }
}