...
class FakeCredentialManager private constructor(private val context: Context) :
    ...
    companion object {
        ...
        fun fakeGoogleCredential(fakeIdToken: String): Credential {
            val bundle = Bundle().apply {
                putString(GoogleIdTokenCredential.BUNDLE_KEY_GOOGLE_ID_TOKEN_SUBTYPE, fakeIdToken)
            }
            return CustomCredential(TYPE_GOOGLE_ID_TOKEN_CREDENTIAL, bundle)
        }
    }
}
