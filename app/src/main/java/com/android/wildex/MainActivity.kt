    ...
    NavHost(navController = navController, startDestination = startDestination) {
        navigation(
            ...
            composable(Screen.Auth.route) {
                TODO("Add authentication screen here")
            }
        }
        ...
        navigation(
            ...
            composable(Screen.Settings.route) {
                TODO("Add settings screen here")
            }
            composable(Screen.EditProfile.route) {
                TODO("Add edit profile screen here")
            }
        }
        ...
        navigation(
            ...
            composable(Screen.Collection.route){
                TODO("Add collection screen here")
            }
        ...
        navigation(
            ...
            composable(Screen.Report.route) {
                TODO("Add report screen here")
            }
            composable(Screen.SubmitReport.route) {
                TODO("Add submit report screen here")
            }
                ...
                uid?.let {
                    ReportDetailsScreen(
                        ...
                        onProfileClick = { userUid ->
                            navigationActions.navigateTo(Screen.Profile(userUid))
                        }
                    )
                }
                    ?: run {
        ...
        composable(Screen.Profile.route) { navBackStackEntry ->
            ...
            uid?.let {
                ProfileScreen(
                    onGoBack = { navigationActions.goBack() },
                    userId = it,
                    onTrophiesClick = { userUid ->
                        navigationActions.navigateTo(Screen.Trophies(userUid))
                    },
