...
object EditProfileScreenTestTags {
  const val GO_BACK = "edit_profile_screen_go_back_button"
    ...
    const val CHANGE_PROFILE_PICTURE =
        "edit_profile_screen_change_profile_picture_button"
...
fun EditProfileScreen(
    ...
    LaunchedEffect(Unit) {
      editScreenViewModel.loadUIState()
    }
  ...
  Scaffold(
      ...
      Column(
          ...
          OutlinedTextField(
              ...
              modifier =
                  Modifier.fillMaxWidth().testTag(EditProfileScreenTestTags.INPUT_NAME))
          // Surname Input
          OutlinedTextField(
              ...
              modifier =
                  Modifier.fillMaxWidth().testTag(EditProfileScreenTestTags.INPUT_SURNAME))
          // User Input
          OutlinedTextField(
              ...
              modifier =
                  Modifier.fillMaxWidth().testTag(EditProfileScreenTestTags.INPUT_USERNAME))
          // Description Input
          OutlinedTextField(
          ...
          Box(modifier = Modifier.fillMaxWidth()) {
              TextButton(
                    ...
                    modifier =
                        Modifier.align(Alignment.Center).testTag(
                            EditProfileScreenTestTags.DROPDOWN_COUNTRY
              )
              ) {
              ...
              DropdownMenu(
                  ...
                  countryList.forEach { country ->
                      ...
                      HorizontalDivider(Modifier, DividerDefaults.Thickness, DividerDefaults.color) // Separate items with a divider
                  }
